...
public class SimpleChat {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Hi you are about to log in ok?",
				"Welcome", JOptionPane.INFORMATION_MESSAGE);
		String s;
		s = JOptionPane.showInputDialog(null, "Would you like to start the IM chat?");
		// JOptionPane.showMessageDialog(null, "You typed " + s);
		// JOptionPane.showMessageDialog(null,"Hi","AHHHHH",JOptionPane.INFORMATION_MESSAGE);
if(s.equals("yes")){
